...
public class Ejecutar {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < listaEnteros.tamano(); i++) {
            System.out.println("Elemento en la posición " + i + ": " + listaEnteros.obtener(i));
        }

        // Eliminar un elemento de la lista
        System.out.println("Elemento eliminado en la posición 2: " + listaEnteros.eliminar(2));
        ...
        System.out.println("¿La lista está vacía? " + listaEnteros.estaVacia());
